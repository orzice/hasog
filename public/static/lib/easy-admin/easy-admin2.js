        ...
        table: {
            ...
            list: function (data, option) {
                ...
                if (value != undefined && value.indexOf(",") != -1) {
                    for(var opt in option.selectList){
                       value = value.replace(new RegExp(opt ,'g'),option.selectList[opt])
                    }
                };
                // console.log(value.replace(new RegExp(value ,'g'),option.selectList[value]));
                // console.log(option.selectList);
                // console.log(option.selectList[value]);
