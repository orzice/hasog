...
<head>
    ...
    <title><?=$lang['An error occurred']?> - HaSog幻神商城</title>
...
<div class="content-container">
    ...
    <div class="buttons-container">
        <a href="/"><?=$lang['Home']?></a>
        <a href="https://cloud.hasog.com/toutiao" target="_blank"><?=$lang['Feedback']?></a>
    </div>
    <div >
        <p style="font-size: 14px;margin: 20px 0;padding: 10px 0;font-weight: 400;">
            开源项目 <a href="https://cloud.hasog.com/toutiao" target="_blank" class="">HaSog幻神商城</a> 驱动，
