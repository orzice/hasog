 ...
 * @ControllerAnnotation(title="支付开关")
 */
class PayType extends AdminController
{
...
//        'sort' => 'desc',
    ...
    public function __construct(App $app)
    {
        ...
        $this->model = new \app\common\model\PayType();
        $this->allowModifyFileds[] = 'status';
        $this->allowModifyFileds[] = 'icon';
        $this->allowModifyFileds[] = 'name';
    }

    /**
     * @NodeAnotation(title="支付开关列表")
     */
