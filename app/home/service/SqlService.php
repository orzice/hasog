...
//=================================================
  ...
  `enable_app` tinyint(1) DEFAULT '0' COMMENT '开启app端支付0否1是',
  `enable_wap` tinyint(1) DEFAULT '0' COMMENT '开启wap端支付0否1是',
  `enable_pc` tinyint(1) DEFAULT '0' COMMENT '开启pc端支付0否1是',
  `create_time` int(11) DEFAULT NULL,
  `update_time` int(11) DEFAULT NULL,
...
(56,  'upload_allow_ext', 'upload', 'gif,jpg,mp3,mp4,pem,png,jpeg',  '允许上传的文件类型',  0,  NULL, NULL),
...
(1, 'system.admin', '管理员管理',  1,  1,  1618133895, 1618133895),
(2, 'system.admin/index', '列表', 2,  1,  1618133895, 1618133895),
(3, 'system.admin/add', '添加', 2,  1,  1618133895, 1618133895),
(4, 'system.admin/edit',  '编辑', 2,  1,  1618133895, 1618133895),
(5, 'system.admin/password',  '编辑', 2,  1,  1618133895, 1618133895),
(6, 'system.admin/delete',  '删除', 2,  1,  1618133895, 1618133895),
(7, 'system.admin/modify',  '属性修改', 2,  1,  1618133895, 1618133895),
(8, 'system.admin/export',  '导出', 2,  1,  1618133895, 1618133895),
(9, 'system.auth',  '角色权限管理', 1,  1,  1618133895, 1618133895),
(10,  'system.auth/authorize',  '授权', 2,  1,  1618133895, 1618133895),
(11,  'system.auth/saveAuthorize',  '授权保存', 2,  1,  1618133895, 1618133895),
(12,  'system.auth/index',  '列表', 2,  1,  1618133895, 1618133895),
(13,  'system.auth/add',  '添加', 2,  1,  1618133895, 1618133895),
(14,  'system.auth/edit', '编辑', 2,  1,  1618133895, 1618133895),
(15,  'system.auth/delete', '删除', 2,  1,  1618133895, 1618133895),
(16,  'system.auth/export', '导出', 2,  1,  1618133895, 1618133895),
(17,  'system.auth/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(18,  'system.config',  '系统配置管理', 1,  1,  1618133895, 1618133895),
(19,  'system.config/index',  '列表', 2,  1,  1618133895, 1618133895),
(20,  'system.config/save', '保存', 2,  1,  1618133895, 1618133895),
(21,  'system.log', '操作日志管理', 1,  1,  1618133895, 1618133895),
(22,  'system.log/index', '列表', 2,  1,  1618133895, 1618133895),
(23,  'system.menu',  '菜单管理', 1,  1,  1618133895, 1618133895),
(24,  'system.menu/index',  '列表', 2,  1,  1618133895, 1618133895),
(25,  'system.menu/add',  '添加', 2,  1,  1618133895, 1618133895),
(26,  'system.menu/edit', '编辑', 2,  1,  1618133895, 1618133895),
(27,  'system.menu/delete', '删除', 2,  1,  1618133895, 1618133895),
(28,  'system.menu/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(29,  'system.menu/getMenuTips',  '添加菜单提示', 2,  1,  1618133895, 1618133895),
(30,  'system.menu/export', '导出', 2,  1,  1618133895, 1618133895),
(31,  'system.node',  '系统节点管理', 1,  1,  1618133895, 1618133895),
(32,  'system.node/index',  '列表', 2,  1,  1618133895, 1618133895),
(33,  'system.node/refreshNode',  '系统节点更新', 2,  1,  1618133895, 1618133895),
(34,  'system.node/clearNode',  '清除失效节点', 2,  1,  1618133895, 1618133895),
(35,  'system.node/add',  '添加', 2,  1,  1618133895, 1618133895),
(36,  'system.node/edit', '编辑', 2,  1,  1618133895, 1618133895),
(37,  'system.node/delete', '删除', 2,  1,  1618133895, 1618133895),
(38,  'system.node/export', '导出', 2,  1,  1618133895, 1618133895),
(39,  'system.node/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(40,  'system.quick', '快捷入口管理', 1,  1,  1618133895, 1618133895),
(41,  'system.quick/index', '列表', 2,  1,  1618133895, 1618133895),
(42,  'system.quick/add', '添加', 2,  1,  1618133895, 1618133895),
(43,  'system.quick/edit',  '编辑', 2,  1,  1618133895, 1618133895),
(44,  'system.quick/delete',  '删除', 2,  1,  1618133895, 1618133895),
(45,  'system.quick/export',  '导出', 2,  1,  1618133895, 1618133895),
(46,  'system.quick/modify',  '属性修改', 2,  1,  1618133895, 1618133895),
(47,  'system.uploadfile',  '上传文件管理', 1,  1,  1618133895, 1618133895),
(48,  'system.uploadfile/type', '修改状态', 2,  1,  1618133895, 1618133895),
(49,  'system.uploadfile/delete', '删除', 2,  1,  1618133895, 1618133895),
(50,  'system.uploadfile/index',  '列表', 2,  1,  1618133895, 1618133895),
(51,  'system.uploadfile/add',  '添加', 2,  1,  1618133895, 1618133895),
(52,  'system.uploadfile/edit', '编辑', 2,  1,  1618133895, 1618133895),
(53,  'system.uploadfile/export', '导出', 2,  1,  1618133895, 1618133895),
(54,  'system.uploadfile/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(55,  'plugin.cloud', '插件云平台',  1,  1,  1618133895, 1618133895),
(56,  'plugin.cloud/index', '云平台',  2,  1,  1618133895, 1618133895),
(57,  'plugin.cloud/up',  '升级插件', 2,  1,  1618133895, 1618133895),
(58,  'plugin.cloud/update',  '在线升级', 2,  1,  1618133895, 1618133895),
(59,  'plugin.index', '插件系统管理', 1,  1,  1618133895, 1618133895),
(60,  'plugin.index/index', '我的插件', 2,  1,  1618133895, 1618133895),
(61,  'plugin.index/install', '安装插件', 2,  1,  1618133895, 1618133895),
(62,  'plugin.index/on',  '开启插件', 2,  1,  1618133895, 1618133895),
(63,  'plugin.index/update_dir',  '更新本地插件', 2,  1,  1618133895, 1618133895),
(64,  'plugin.index/off', '关闭插件', 2,  1,  1618133895, 1618133895),
(65,  'plugin.index/del', '卸载插件', 2,  1,  1618133895, 1618133895),
(66,  'pay.ali_pay',  '支付宝支付',  1,  1,  1618133895, 1618133895),
(67,  'pay.ali_pay/index',  '支付宝支付列表',  2,  1,  1618133895, 1618133895),
(68,  'pay.ali_pay/add',  '添加', 2,  1,  1618133895, 1618133895),
(69,  'pay.ali_pay/edit', '编辑', 2,  1,  1618133895, 1618133895),
(70,  'pay.ali_pay/delete', '删除', 2,  1,  1618133895, 1618133895),
(71,  'pay.ali_pay/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(72,  'pay.ali_pay/getMenuTips',  '添加菜单提示', 2,  1,  1618133895, 1618133895),
(73,  'pay.ali_pay/export', '导出', 2,  1,  1618133895, 1618133895),
(74,  'pay.pay_type', '支付开关', 1,  1,  1618133895, 1618133895),
(75,  'pay.pay_type/index', '支付开关列表', 2,  1,  1618133895, 1618133895),
(76,  'pay.pay_type/edit',  '编辑', 2,  1,  1618133895, 1618133895),
(77,  'pay.pay_type/delete',  '删除', 2,  1,  1618133895, 1618133895),
(78,  'pay.pay_type/modify',  '属性修改', 2,  1,  1618133895, 1618133895),
(79,  'pay.pay_type/getMenuTips', '添加菜单提示', 2,  1,  1618133895, 1618133895),
(80,  'pay.pay_type/add', '添加', 2,  1,  1618133895, 1618133895),
(81,  'pay.pay_type/export',  '导出', 2,  1,  1618133895, 1618133895),
(82,  'pay.wechat_pay', '微信支付', 1,  1,  1618133895, 1618133895),
(83,  'pay.wechat_pay/index', '微信支付列表', 2,  1,  1618133895, 1618133895),
(84,  'pay.wechat_pay/add', '添加', 2,  1,  1618133895, 1618133895),
(85,  'pay.wechat_pay/edit',  '编辑', 2,  1,  1618133895, 1618133895),
(86,  'pay.wechat_pay/delete',  '删除', 2,  1,  1618133895, 1618133895),
(87,  'pay.wechat_pay/modify',  '属性修改', 2,  1,  1618133895, 1618133895),
(88,  'pay.wechat_pay/getMenuTips', '添加菜单提示', 2,  1,  1618133895, 1618133895),
(89,  'pay.wechat_pay/export',  '导出', 2,  1,  1618133895, 1618133895),
(90,  'page.carousel',  '轮播图管理',  1,  1,  1618133895, 1618133895),
(91,  'page.carousel/index',  '轮播图管理列表',  2,  1,  1618133895, 1618133895),
(92,  'page.carousel/add',  '轮播图管理添加',  2,  1,  1618133895, 1618133895),
(93,  'page.carousel/edit', '轮播图管理修改',  2,  1,  1618133895, 1618133895),
(94,  'page.carousel/delete', '删除', 2,  1,  1618133895, 1618133895),
(95,  'page.carousel/export', '导出', 2,  1,  1618133895, 1618133895),
(96,  'page.carousel/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(97,  'page.navigation',  '导航管理', 1,  1,  1618133895, 1618133895),
(98,  'page.navigation/index',  '导航管理列表', 2,  1,  1618133895, 1618133895),
(99,  'page.navigation/add',  '导航管理添加', 2,  1,  1618133895, 1618133895),
(100, 'page.navigation/edit', '导航管理修改', 2,  1,  1618133895, 1618133895),
(101, 'page.navigation/delete', '删除', 2,  1,  1618133895, 1618133895),
(102, 'page.navigation/export', '导出', 2,  1,  1618133895, 1618133895),
(103, 'page.navigation/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(104, 'page.notice',  '公告管理', 1,  1,  1618133895, 1618133895),
(105, 'page.notice/index',  '公告管理列表', 2,  1,  1618133895, 1618133895),
(106, 'page.notice/add',  '公告管理添加', 2,  1,  1618133895, 1618133895),
(107, 'page.notice/edit', '公告管理修改', 2,  1,  1618133895, 1618133895),
(108, 'page.notice/delete', '删除', 2,  1,  1618133895, 1618133895),
(109, 'page.notice/export', '导出', 2,  1,  1618133895, 1618133895),
(110, 'page.notice/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(111, 'order.home', '订单管理', 1,  1,  1618133895, 1618133895),
(112, 'order.home/index', '订单列表', 2,  1,  1618133895, 1618133895),
(113, 'order.home/edit',  '订单编辑', 2,  1,  1618133895, 1618133895),
(114, 'order.home/batch_delivery',  '获取批量发货模版', 2,  1,  1618133895, 1618133895),
(115, 'order.home/receive_money', '确认收款', 2,  1,  1618133895, 1618133895),
(116, 'order.home/send_goods',  '发货', 2,  1,  1618133895, 1618133895),
(117, 'order.home/receive_goods', '确认收货', 2,  1,  1618133895, 1618133895),
(118, 'order.home/refund_order',  '退款订单', 2,  1,  1618133895, 1618133895),
(119, 'order.home/apply_cancel',  '申请退款', 2,  1,  1618133895, 1618133895),
(120, 'order.home/cancel_order',  '取消订单', 2,  1,  1618133895, 1618133895),
(121, 'order.home/batch_delivery_data', '批量发货', 2,  1,  1618133895, 1618133895),
(122, 'order.home/export',  '导出', 2,  1,  1618133895, 1618133895),
(123, 'order.order_refund', '订单退款', 1,  1,  1618133895, 1618133895),
(124, 'order.order_refund/index', '退款列表', 2,  1,  1618133895, 1618133895),
(125, 'order.order_refund/edit',  '审核退款', 2,  1,  1618133895, 1618133895),
(126, 'member.transfer_credit', '积分管理', 1,  1,  1618133895, 1618133895),
(127, 'member.transfer_credit/index', '列表', 2,  1,  1618133895, 1618133895),
(128, 'member.transfer_credit/add', '新增积分类型', 2,  1,  1618133895, 1618133895),
(129, 'member.transfer_credit/edit',  '编辑积分类型', 2,  1,  1618133895, 1618133895),
(130, 'member.transfer_credit/credit_set',  '积分配置列表', 2,  1,  1618133895, 1618133895),
(131, 'member.transfer_credit/modify',  '属性修改', 2,  1,  1618133895, 1618133895),
(132, 'member.transfer_credit/list',  '转账数据列表', 2,  1,  1618133895, 1618133895),
(133, 'member.transfer_credit/delete',  '删除', 2,  1,  1618133895, 1618133895),
(134, 'member.transfer_credit/export',  '导出', 2,  1,  1618133895, 1618133895),
(135, 'member.user',  '会员管理', 1,  1,  1618133895, 1618133895),
(136, 'member.user/index',  '列表', 2,  1,  1618133895, 1618133895),
(137, 'member.user/add',  '添加账号', 2,  1,  1618133895, 1618133895),
(138, 'member.user/edit', '编辑账号', 2,  1,  1618133895, 1618133895),
(139, 'member.user/parent', '修改推荐人',  2,  1,  1618133895, 1618133895),
(140, 'member.user/recharge_balance', '余额充值', 2,  1,  1618133895, 1618133895),
(141, 'member.user/password', '修改密码', 2,  1,  1618133895, 1618133895),
(142, 'member.user/delete', '删除', 2,  1,  1618133895, 1618133895),
(143, 'member.user/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(144, 'member.user/export', '导出', 2,  1,  1618133895, 1618133895),
(145, 'goods.category', '商品分类管理', 1,  1,  1618133895, 1618133895),
(146, 'goods.category/index', '商品分类列表', 2,  1,  1618133895, 1618133895),
(147, 'goods.category/add', '添加商品分类', 2,  1,  1618133895, 1618133895),
(148, 'goods.category/edit',  '编辑商品分类', 2,  1,  1618133895, 1618133895),
(149, 'goods.category/delete',  '删除商品分类', 2,  1,  1618133895, 1618133895),
(150, 'goods.category/modify',  '属性修改', 2,  1,  1618133895, 1618133895),
(151, 'goods.category/getMenuTips', '添加菜单提示', 2,  1,  1618133895, 1618133895),
(152, 'goods.category/export',  '导出', 2,  1,  1618133895, 1618133895),
(153, 'goods.dispatch', '配送管理', 1,  1,  1618133895, 1618133895),
(154, 'goods.dispatch/index', '列表', 2,  1,  1618133895, 1618133895),
(155, 'goods.dispatch/add', '添加', 2,  1,  1618133895, 1618133895),
(156, 'goods.dispatch/delete',  '删除', 2,  1,  1618133895, 1618133895),
(157, 'goods.dispatch/modify',  '属性修改', 2,  1,  1618133895, 1618133895),
(158, 'goods.dispatch/data',  '配送逻辑', 2,  1,  1618133895, 1618133895),
(159, 'goods.dispatch/dataedit',  '编辑配送逻辑', 2,  1,  1618133895, 1618133895),
(160, 'goods.dispatch/dataadd', '添加配送逻辑', 2,  1,  1618133895, 1618133895),
(161, 'goods.dispatch/datadelete',  '删除配送逻辑', 2,  1,  1618133895, 1618133895),
(162, 'goods.dispatch/datamodify',  '属性修改配送逻辑', 2,  1,  1618133895, 1618133895),
(163, 'goods.dispatch/edit',  '编辑', 2,  1,  1618133895, 1618133895),
(164, 'goods.dispatch/export',  '导出', 2,  1,  1618133895, 1618133895),
(165, 'goods.home', '商品管理', 1,  1,  1618133895, 1618133895),
(166, 'goods.home/index', '列表', 2,  1,  1618133895, 1618133895),
(167, 'goods.home/add', '添加', 2,  1,  1618133895, 1618133895),
(168, 'goods.home/edit',  '修改', 2,  1,  1618133895, 1618133895),
(169, 'goods.home/delete',  '删除', 2,  1,  1618133895, 1618133895),
(170, 'goods.home/export',  '导出', 2,  1,  1618133895, 1618133895),
(171, 'goods.home/modify',  '属性修改', 2,  1,  1618133895, 1618133895),
(172, 'finace.balanceset',  '余额设置', 1,  1,  1618133895, 1618133895),
(173, 'finace.balanceset/edit', '余额设置修改', 2,  1,  1618133895, 1618133895),
(174, 'finace.balanceset/index',  '列表', 2,  1,  1618133895, 1618133895),
(175, 'finace.balanceset/add',  '添加', 2,  1,  1618133895, 1618133895),
(176, 'finace.balanceset/delete', '删除', 2,  1,  1618133895, 1618133895),
(177, 'finace.balanceset/export', '导出', 2,  1,  1618133895, 1618133895),
(178, 'finace.balanceset/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(179, 'finace.balancesub',  '余额明细', 1,  1,  1618133895, 1618133895),
(180, 'finace.balancesub/index',  '余额明细列表', 2,  1,  1618133895, 1618133895),
(181, 'finace.balancesub/add',  '添加', 2,  1,  1618133895, 1618133895),
(182, 'finace.balancesub/edit', '编辑', 2,  1,  1618133895, 1618133895),
(183, 'finace.balancesub/delete', '删除', 2,  1,  1618133895, 1618133895),
(184, 'finace.balancesub/export', '导出', 2,  1,  1618133895, 1618133895),
(185, 'finace.balancesub/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(186, 'finace.income',  '收入明细', 1,  1,  1618133895, 1618133895),
(187, 'finace.income/index',  '收入明细列表', 2,  1,  1618133895, 1618133895),
(188, 'finace.income/add',  '添加', 2,  1,  1618133895, 1618133895),
(189, 'finace.income/edit', '编辑', 2,  1,  1618133895, 1618133895),
(190, 'finace.income/delete', '删除', 2,  1,  1618133895, 1618133895),
(191, 'finace.income/export', '导出', 2,  1,  1618133895, 1618133895),
(192, 'finace.income/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(193, 'finace.offlinepayment',  '线下收款记录', 1,  1,  1618133895, 1618133895),
(194, 'finace.offlinepayment/index',  '线下收款记录列表', 2,  1,  1618133895, 1618133895),
(195, 'finace.offlinepayment/edit', '线下收款记录查看', 2,  1,  1618133895, 1618133895),
(196, 'finace.offlinepayment/add',  '添加', 2,  1,  1618133895, 1618133895),
(197, 'finace.offlinepayment/delete', '删除', 2,  1,  1618133895, 1618133895),
(198, 'finace.offlinepayment/export', '导出', 2,  1,  1618133895, 1618133895),
(199, 'finace.offlinepayment/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(200, 'finace.offlinewithdrawals',  '线下提现记录', 1,  1,  1618133895, 1618133895),
(201, 'finace.offlinewithdrawals/index',  '线下提现记录列表', 2,  1,  1618133895, 1618133895),
(202, 'finace.offlinewithdrawals/edit', '线下提现记录修改', 2,  1,  1618133895, 1618133895),
(203, 'finace.offlinewithdrawals/add',  '添加', 2,  1,  1618133895, 1618133895),
(204, 'finace.offlinewithdrawals/delete', '删除', 2,  1,  1618133895, 1618133895),
(205, 'finace.offlinewithdrawals/export', '导出', 2,  1,  1618133895, 1618133895),
(206, 'finace.offlinewithdrawals/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(207, 'finace.upbalance', '充值余额', 1,  1,  1618133895, 1618133895),
(208, 'finace.upbalance/index', '充值余额列表', 2,  1,  1618133895, 1618133895),
(209, 'finace.upbalance/edit',  '充值余额修改', 2,  1,  1618133895, 1618133895),
(210, 'finace.upbalance/add', '添加', 2,  1,  1618133895, 1618133895),
(211, 'finace.upbalance/delete',  '删除', 2,  1,  1618133895, 1618133895),
(212, 'finace.upbalance/export',  '导出', 2,  1,  1618133895, 1618133895),
(213, 'finace.upbalance/modify',  '属性修改', 2,  1,  1618133895, 1618133895),
(214, 'finace.uprecord',  '充值记录', 1,  1,  1618133895, 1618133895),
(215, 'finace.uprecord/index',  '充值记录列表', 2,  1,  1618133895, 1618133895),
(216, 'finace.uprecord/add',  '添加', 2,  1,  1618133895, 1618133895),
(217, 'finace.uprecord/edit', '编辑', 2,  1,  1618133895, 1618133895),
(218, 'finace.uprecord/delete', '删除', 2,  1,  1618133895, 1618133895),
(219, 'finace.uprecord/export', '导出', 2,  1,  1618133895, 1618133895),
(220, 'finace.uprecord/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(221, 'finace.withdrawalrecord',  '用户提现记录', 1,  1,  1618133895, 1618133895),
(222, 'finace.withdrawalrecord/index',  '用户提现记录列表', 2,  1,  1618133895, 1618133895),
(223, 'finace.withdrawalrecord/add',  '添加', 2,  1,  1618133895, 1618133895),
(224, 'finace.withdrawalrecord/edit', '编辑', 2,  1,  1618133895, 1618133895),
(225, 'finace.withdrawalrecord/delete', '删除', 2,  1,  1618133895, 1618133895),
(226, 'finace.withdrawalrecord/export', '导出', 2,  1,  1618133895, 1618133895),
(227, 'finace.withdrawalrecord/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(228, 'finace.withdrawset', '提现设置', 1,  1,  1618133895, 1618133895),
(229, 'finace.withdrawset/edit',  '提现设置修改', 2,  1,  1618133895, 1618133895),
(230, 'finace.withdrawset/index', '列表', 2,  1,  1618133895, 1618133895),
(231, 'finace.withdrawset/add', '添加', 2,  1,  1618133895, 1618133895),
(232, 'finace.withdrawset/delete',  '删除', 2,  1,  1618133895, 1618133895),
(233, 'finace.withdrawset/export',  '导出', 2,  1,  1618133895, 1618133895),
(234, 'finace.withdrawset/modify',  '属性修改', 2,  1,  1618133895, 1618133895),
(235, 'finace.withdrawsts', '提现统计', 1,  1,  1618133895, 1618133895),
(236, 'finace.withdrawsts/index', '提现统计列表', 2,  1,  1618133895, 1618133895),
(237, 'finace.withdrawsts/add', '添加', 2,  1,  1618133895, 1618133895),
(238, 'finace.withdrawsts/edit',  '编辑', 2,  1,  1618133895, 1618133895),
(239, 'finace.withdrawsts/delete',  '删除', 2,  1,  1618133895, 1618133895),
(240, 'finace.withdrawsts/export',  '导出', 2,  1,  1618133895, 1618133895),
(241, 'finace.withdrawsts/modify',  '属性修改', 2,  1,  1618133895, 1618133895),
(242, 'admins.feedback',  '用户回馈', 1,  1,  1618133895, 1618133895),
(243, 'admins.feedback/index',  '用户回馈列表', 2,  1,  1618133895, 1618133895),
(244, 'admins.feedback/edit', '用户回馈查看', 2,  1,  1618133895, 1618133895),
(245, 'admins.feedback/add',  '添加', 2,  1,  1618133895, 1618133895),
(246, 'admins.feedback/delete', '删除', 2,  1,  1618133895, 1618133895),
(247, 'admins.feedback/export', '导出', 2,  1,  1618133895, 1618133895),
(248, 'admins.feedback/modify', '属性修改', 2,  1,  1618133895, 1618133895),
(249, 'admins.feedbackset', '反馈黑名单',  1,  1,  1618133895, 1618133895),
(250, 'admins.feedbackset/index', '反馈黑名单列表',  2,  1,  1618133895, 1618133895),
(251, 'admins.feedbackset/add', '反馈黑名单添加',  2,  1,  1618133895, 1618133895),
(252, 'admins.feedbackset/edit',  '编辑', 2,  1,  1618133895, 1618133895),
(253, 'admins.feedbackset/delete',  '删除', 2,  1,  1618133895, 1618133895),
(254, 'admins.feedbackset/export',  '导出', 2,  1,  1618133895, 1618133895),
(255, 'admins.feedbackset/modify',  '属性修改', 2,  1,  1618133895, 1618133895),
(256, 'admins.payment', '线下付款配置', 1,  1,  1618133895, 1618133895),
(257, 'admins.payment/index', '线下付款配置列表', 2,  1,  1618133895, 1618133895),
(258, 'admins.payment/add', '线下付款配置添加', 2,  1,  1618133895, 1618133895),
(259, 'admins.payment/edit',  '线下付款配置修改', 2,  1,  1618133895, 1618133895),
(260, 'admins.payment/delete',  '删除', 2,  1,  1618133895, 1618133895),
(261, 'admins.payment/export',  '导出', 2,  1,  1618133895, 1618133895),
(262, 'admins.payment/modify',  '属性修改', 2,  1,  1618133895, 1618133895),
(263, 'plugin', '插件开启权限', 1,  1,  1618133895, 1618133895),
(264, 'plugin/default', '插件详情', 2,  1,  1618133895, 1618133895),
(265, 'plugin/call',  '插件HOOK', 2,  1,  1618133895, 1618133895)
